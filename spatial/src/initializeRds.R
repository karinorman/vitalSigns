...
tanz_coord <- rbind(vs_countries@polygons[[3]]@Polygons[[1]]@coords,
                    vs_countries@polygons[[3]]@Polygons[[2]]@coords,
                    vs_countries@polygons[[3]]@Polygons[[3]]@coords,
                    vs_countries@polygons[[3]]@Polygons[[4]]@coords)
uga_coord <- vs_countries@polygons[[4]]@Polygons[[1]]@coords
rwa_coord <- vs_countries@polygons[[2]]@Polygons[[1]]@coords
