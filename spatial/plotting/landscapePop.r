...
setwd('~/Dropbox/vitalSigns/')
load('saved/spatial/tanz_stats.rdata')
load('saved/spatial/gha_stats.rdata')
load('saved/spatial/ug_stats.rdata')


## LCP: what is this all about?
...
simpson <- rbind(div.tanz[,c('country', 'buffer', 'simpson.div')],
                 div.gha[,c('country', 'buffer', 'simpson.div')],
                 div.ug[,c('country', 'buffer', 'simpson.div')])
